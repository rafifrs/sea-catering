...
const MealPlansPage: React.FC = () => {
  ...
  const [selectedMealPlan, setSelectedMealPlan] = useState<MealPlanWithMeals | null>(null)
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <h1 className="text-5xl font-bold text-white mb-4 mt-20">Our Meal Plans</h1>
            <p className="text-xl text-orange-100">Choose the perfect meal plan for your lifestyle and goals</p>
          </motion.div>
        </div>
      </motion.div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex bg-orange-100 rounded-lg p-1">
              <Button
                ...
                className={viewMode === 'grid' ? 'bg-orange-500 text-white' : 'text-orange-600 hover:bg-orange-200'}
              >
              ...
              <Button
                ...
                className={viewMode === 'list' ? 'bg-orange-500 text-white' : 'text-orange-600 hover:bg-orange-200'}
              >
        ...
        <AnimatePresence>
          {filteredMealPlans.length === 0 ? (
            ...
            >
              ...
              <p className="text-orange-400 text-xl font-medium">No meal plans found</p>
              <p className="text-orange-300 mt-2">Try adjusting your search or filters</p>
            </motion.div>
          ) : (
            <motion.div 
